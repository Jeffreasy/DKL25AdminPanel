    ...
    <>
      <div
        ...
        className={`
          ...
          hover:shadow-xl transition-shadow duration-300 touch-pan-y
        `}
      ...
      >
        ...
        {photos.length > 1 && (
            <div 
                className="absolute inset-x-4 top-1/2 -translate-y-1/2 flex items-center justify-between opacity-0 group-hover:opacity-100 transition-opacity duration-200"
