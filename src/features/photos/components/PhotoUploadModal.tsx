...
import { ImageUploadClient, photoApiClient } from '../../../api/client'
import { cc } from '../../../styles/shared'
import { XMarkIcon } from '@heroicons/react/24/outline'
import type { AlbumWithDetails } from '../../albums/types'
import { addPhotosToAlbums } from '../services/photoService'
    ...
    try {
      ...
      if (result.data && result.data.length > 0) {
        for (const [index, imageData] of result.data.entries()) {
          ...
          // Insert photo record using photoApiClient
          ...
          if (response.success && response.data) {
            ...
            const photoData = response.data as any
            if (photoData.id) {
